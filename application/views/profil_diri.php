        ...
        <div class="row">
          ...
          <div class="card">
              ...
              <div class="card-body">
                ...
                <img src="<?= base_url('assets/dist/img/jugram.jpg') ?>" class="img-thumbnail" alt="Tidak Ada">
                  </div>
                  ...
                  <form>
                   ...
                   <input type="button" class="form-control" id="exampleInputPassword1">
                   </div>
                   <div class="mb-3">
                   <label for="exampleInputPassword1" class="form-label">Checkbox</label>
                   ...
                   <div class="mb-3">
                   <label for="exampleInputPassword1" class="form-label">Datetime</label>
                   ...
                   <div class="mb-3">
                   <label for="exampleInputPassword1" class="form-label">Hidden</label>
                   <input type="hidden" class="form-control" id="exampleInputPassword1">
                   </div>
                   <div class="mb-3">
                   <label for="exampleInputPassword1" class="form-label">Image</label>
                   <input type="image" class="form-control" id="exampleInputPassword1">
                   </div>
                   <div class="mb-3">
                   ...
                   <div class="mb-3">
                   <label for="exampleInputPassword1" class="form-label">Radio</label>
                   ...
                   <div class="mb-3">
                   <label for="exampleInputPassword1" class="form-label">Reset</label>
                   <input type="reset" class="form-control" id="exampleInputPassword1">
                   </div>
                   <div class="mb-3">
                   ...
                   <input type="submit" class="form-control" id="exampleInputPassword1">
                   </div>
                   <div class="mb-3">
                   ...
                   <input type="week" class="form-control" id="exampleInputPassword1">
                   </div>
